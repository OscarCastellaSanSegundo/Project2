                    ...
                    <!--                                                 <input type="text" class="form-control form-control-sm" placeholder="Municipi" aria-label="Provincia" aria-describedby="button-addon2" name="municipis_id"> -->
                                ...
                                <div class="row">
                                    <div class="col-5">
                                        ...
                                        <select class="form-control" name="tipus_incident" id="tipus_incident" v-model="tipusIncident">
                                            <option v-for="tipusIncident in tipusIncidents" :key="tipusIncident.id" :value="tipusIncident.id" @hit= "onIncidentSel">{{ tipusIncident.descripcio }}</option>
                                        </select>
    ...
    <!--                                 <input name="usuaris_id" type="hidden" value="{{ Auth::user()->id }}" id="temps_trucada"> -->
                    ...
                    <div class="card informacionLlamante bordeRedondo zoomCard" style="width: 100%; margin-top: 10px">
                        <div class="card-body">
                            ...
                            <div class="form-group row mb-2">
                                <div class="col-sm-10">
                                    <input type="number" class="form-control form-control-sm" placeholder="Telèfon" aria-label="Telefono" aria-describedby="button-addon2" id="telefon" name="telefon" v-model="cartaTrucada.telefon">
                                </div>
                                <a class="col-sm-2 col-navbar-brand-sm" href="#">
                                    <img :src="imagenHelpbox" alt="" width="20" height="20">
                                </a>
