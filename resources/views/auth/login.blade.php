        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col col-xl-10">
                <div class="card" style="border-radius: 1rem;">
                    <div class="row g-0">
                        <div class="col-md-6">
                            <img src="../public/imagenes/Logo1Vector1.png" class="img-fluid rounded-start" alt="...">
                        </div>
                        <div class="col-md-6">
                            <div class="card-body">
                                <form action="{{ action([App\Http\Controllers\UsuariController::class, 'login']) }}" method="POST">
                                    ...
                                    <div class="form-outline mb-4">
                                        <input type="email" id="codi" class="form-control form-control-lg" name="codi" value="{{ old('codi') }}"/>
